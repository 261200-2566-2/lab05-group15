public class Warrior implements Character{
    ...
    protected double attackSpeedPenealty = 0;
    protected double attackSpeed = maxAttackSpeed*((100-attackSpeedPenealty)/100);
    ...
    Warrior(String name,int level,Sword sword){
        this.name = name;
        this.level = level;
        attack = sword.damage;
        swordEquipped = true;
        this.sword = sword;
        attackSpeedPenealty += 5;
        updateStat();
        hp = maxHP;
        mana = maxMana;
    }
    Warrior(String name,int level,Shield shield){
        this.name = name;
        this.level = level;
        defense = shield.defense;
        shieldEquipped = true;
        this.shield = shield;
        attackSpeedPenealty += 10;
        updateStat();
        hp = maxHP;
        mana = maxMana;
    }
    Warrior(String name,int level,Sword sword,Shield shield){
        this.name = name;
        this.level = level;
        attack = sword.damage;
        swordEquipped = true;
    ...
    public void updateStat(){
        ...
        attackSpeed = maxAttackSpeed*((100-attackSpeedPenealty)/100);
    ...
    public void attack(Warrior opponent){
        if(!dead && !guarded){
            ...
            System.out.println(name + " is now on guarded. " + name + " can't attack.");
        }
    }
    ...
    public void guard(){
        if(!guarded){
            ...
            System.out.println(name + " is already on guard!");
        }
    }
    public void unGuard(){
        if (guarded) {
            ...
            System.out.println(name + " isn't on guarded!");
        }
    }
}
